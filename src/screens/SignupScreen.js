          ...
          <ScrollView>
            <KeyboardAvoidingView behavior="padding">
              <View style={styles.form_wrapper}>
                ...
                {emailError && (
                  <Text style={styles.error_text}> eg: xyz@gmail.com</Text>
                )}
                {/* <View style={styles.inputfields}> */}
                ...
                <View style={styles.inputfields}>
                  ...
                  <TextInput
                    ...
                    onChangeText={handleConfirmPassword}></TextInput>
                  <TouchableOpacity
                    style={styles.inputfields_icons}
                    onPress={handlePasswordShow}
                    activeOpacity={0.8}>
                ...
                <View style={styles.terms_container}>
                  ...
                  <View
                    ...
                    <Text style={styles.terms_label}>
                      I agree to the{' '}
                      <Text
                        onPress={openTermsAndConditionsLink}
                        style={{
