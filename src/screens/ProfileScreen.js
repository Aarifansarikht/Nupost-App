...
import { Image, View, Button, Text, StyleSheet ,Linking,PermissionsAndroid ,Alert} from 'react-native';
...
function ProfileScreen({ navigation }) {
    ...
    try {
        ...
        console.log("URL1_____________", imageUrl, "URL2_______________________", imageUrl1);
                            ...
                            {userData?.userData && userData?.userData.email ? (
                                <>
                                    <View >
                                        ...
                                        <TextInput style={styles.textInput}   value={mobileNumber !== null ? mobileNumber : userData.userData.mobileNumber} placeholder='Mobile Number' placeholderTextColor="#888" onChangeText={(text) => setMobileNumber(text)} />
                                        <TextInput style={styles.textInput} value={WhatsappNumber !== null ? WhatsappNumber : userData.userData.WhatsappNumber} placeholder='WhatsApp Number' placeholderTextColor="#888" onChangeText={(text) => setWhatsappNumber(text)} />
                                        <TextInput style={styles.textInput} value={ designation !== null ? designation : userData.userData.designation  } placeholder='Designation' placeholderTextColor="#888" onChangeText={(text) => setDesignation(text)} />
                                        <DropdownComponent onPartySelect={handlePartySelect} politicalParty={userData.userData.politicalParty}/>
                                        ...
                                        {showInsta && <View>
                                          <TextInput style={styles.textInput} value={ InstaUrl !== null ? InstaUrl : userData.userData.InstaUrl} placeholder='Paste Instagram Url' placeholderTextColor="#888" onChangeText={(text) => setInstaUrl(text)} />
                                             </View> }
                                             {showFacebook && <View>
                                          <TextInput style={styles.textInput} value={ FacebookUrl !== null ? FacebookUrl : userData.userData.FacebookUrl} placeholder='Paste Facebook Url' placeholderTextColor="#888" onChangeText={(text) => setFacebookUrl(text)} />
                                             </View> }
                                             {showTwitter && <View>
                                          <TextInput style={styles.textInput} value={TwitterUrl !== null ? TwitterUrl : userData.userData.TwitterUrl} placeholder='Paste Twitter Url' placeholderTextColor="#888" onChangeText={(text) => setTwitterUrl(text)} />
                                             </View> }
                                             <Text style={{fontSize:15,color:"black",textAlign:"center"}}>For Adding Social Media Accounts click below.</Text>
