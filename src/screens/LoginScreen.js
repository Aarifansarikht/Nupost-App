    ...
    <SafeAreaView style={styles.main_container}>
      <View style={styles.top_container}>
        <Image
          ...
          source={require('../assets/img/welcomeimg.png')}></Image>
      </View>
        ...
        <ScrollView>
          <KeyboardAvoidingView behavior="padding">
            <View style={styles.form_wrapper}>
              ...
              {emailError && (
                <Text style={styles.error_text}>Email must be filled out.</Text>
              )}
              <View style={styles.inputfields}>
                <MaterialIcons
                  name="lock"
              ...
              <View>
                {loginError && (
                  <Text style={styles.login_error_text}>{loginError}</Text>
                )}
              </View>
            </View>
            <AwesomeAlert
              ...
              message={
                'Are you sure, You want to submit the reset password request?'
              }
