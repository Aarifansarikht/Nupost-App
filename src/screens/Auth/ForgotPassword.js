                ...
                <KeyboardAvoidingView behavior='padding'>
                    <View style={styles.form_wrapper}>
                        <View style={styles.login_text_container}>
                            ...
                            <Text>If you forgot your password, well, then we’ll email you instructions to reset your password.</Text>
                        </View>

                        <View style={styles.inputfields}>
                            <TextInput style={styles.textfields} placeholder='Email address or Phone Number' placeholderTextColor={'gray'} value={email} onChangeText={(text) => setEmail(text)}></TextInput>
                        </View>
...

                        {
                            clicked ? <TouchableOpacity style={styles.submit_btn} activeOpacity={0.7} onPress={handleFormValidation}>
                                ...
                                <Text style={styles.submit_btn_text}>SEND OTP</Text>
